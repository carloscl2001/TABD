...
NESTED TABLE Lista_diagnosticos STORE AS Diagnostico;
...
NESTED TABLE Lista_medicamentos STORE AS Medicamento;
...
NESTED TABLE Lista_citas STORE AS Cita;
...
NESTED TABLE Lista_medicos STORE AS Medico;

--HOSPITAL
CREATE TABLE Hospital OF Tipo_Hospital(
    CONSTRAINT PK_Hospital PRIMARY KEY(Nombre)
)
NESTED TABLE Lista_departamentos STORE AS Departamento;