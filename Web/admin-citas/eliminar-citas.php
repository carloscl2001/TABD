...
<div id="contenedor">
    ...
    echo "<br><br><hr style='border-top: 3px solid orange; border-bottom: 3px solid orange;'><p style='color:orange; text-align:center; font-size: 1.5em;'>Se han eliminado todas las citas.</p><hr style='border-top: 3px solid orange; border-bottom: 3px solid orange;'>";
    ?>
</div>
